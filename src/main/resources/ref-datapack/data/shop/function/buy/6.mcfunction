tag @s remove shop_buy_6
execute if score @s wealth_gunpowder matches 5.. if score @s wealth_tnt matches 1.. run tellraw @a [{"selector": "@s"},{ "text": " 购买了 ","color": "white"},{"text": "黑化心粒子","color": "white","underlined": true}]
execute if score @s wealth_gunpowder matches 5.. if score @s wealth_tnt matches 1.. run tellraw @s [{ "text": "再次点击选择 ","color": "white"},{"text": "黑化心粒子","color": "white","underlined": true}]
...
execute if score @s wealth_gunpowder matches 5.. if score @s wealth_tnt matches 1.. run advancement grant @s only shop:6
