tag @s remove shop_buy_7
execute if score @s wealth_gunpowder matches 10.. run tellraw @a [{"selector": "@s"},{ "text": " 购买了 ","color": "white"},{"text": "孢子粒子","color": "white","underlined": true}]
execute if score @s wealth_gunpowder matches 10.. run tellraw @s [{ "text": "再次点击选择 ","color": "white"},{"text": "孢子粒子","color": "white","underlined": true}]
...
execute if score @s wealth_gunpowder matches 10.. run advancement grant @s only shop:7
