...
execute as @s at @s anchored eyes positioned ^ ^ ^-1 run summon arrow ~ ~ ~ {Tags:["job_2_2_new","job_2_2"],damage:0.6d,SoundEvent:"minecraft:entity.player.attack.crit",HasBeenShot:1b,LeftOwner:1b,shake:0b,crit:0b,pickup:0b}
...
execute as @s at @s anchored eyes positioned ^-1 ^ ^-1 run summon arrow ~ ~ ~ {Tags:["job_2_2_new","job_2_2"],damage:0.6d,SoundEvent:"minecraft:entity.player.attack.crit",HasBeenShot:1b,LeftOwner:1b,shake:0b,crit:0b,pickup:0b}
execute at @e[tag=job_2_2_new] run tp @e[tag=job_2_2_new] ~ ~ ~ facing entity @s
