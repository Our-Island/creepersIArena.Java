...
clear @s stone_button[custom_name={"text": "冷却中","color": "white","italic": false},lore=[{"text": "9-技能","color": "gray","italic": false}]]
...
$item replace entity @s hotbar.8 with stone_button[custom_name={"text": "冷却中","color": "white","italic": false},lore=[{"text": "9-技能","color": "gray","italic": false}]] $(cd_9)