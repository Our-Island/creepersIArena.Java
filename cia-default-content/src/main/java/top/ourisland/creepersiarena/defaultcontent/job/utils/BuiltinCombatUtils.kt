package top.ourisland.creepersiarena.defaultcontent.job.utils
...
import top.ourisland.creepersiarena.defaultcontent.job.utils.BuiltinCombatUtils.installSessions
import top.ourisland.creepersiarena.defaultcontent.job.utils.BuiltinCombatUtils.isEnemy
import top.ourisland.creepersiarena.defaultcontent.job.utils.BuiltinCombatUtils.nearbyOtherPlayers
import top.ourisland.creepersiarena.defaultcontent.job.utils.BuiltinCombatUtils.rayOtherPlayer
...
object BuiltinCombatUtils {
    ...
    fun glow(player: Player, ticks: Int) {
        EntityStateUtils.applyHiddenEffect(player, PotionEffectType.GLOWING, ticks)
    }
