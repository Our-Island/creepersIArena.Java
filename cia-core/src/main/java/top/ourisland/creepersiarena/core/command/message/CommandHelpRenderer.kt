    ...
    public void playerHelp(CommandSender sender) {
        messenger.panel(
                ...
                CommandPanel.builder("Player Commands")
                        ...
                        .row(new CommandUsage("/cia pref", "View or update command preferences.").toMiniRow())
                        .row("")
    ...
    public void adminHelp(CommandSender sender) {
        messenger.panel(
                ...
                CommandPanel.builder("Admin Commands")
                        ...
                        .row(new CommandUsage("/ciaa extension list", "Inspect loaded CIA extensions.").toMiniRow())
                        .row(new CommandUsage("/ciaa config get/list/set/reload", "Inspect or safely update config files.").toMiniRow())
