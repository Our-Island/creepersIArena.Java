 ...
 *
 * @see top.ourisland.creepersiarena.core.component.discovery.AnnotationComponentScanner
 * @see top.ourisland.creepersiarena.core.component.metadata.SkillMetadata
...
public @interface CiaSkillDef {
     ...
     * <p>
     * The owning job id is used by the catalog to group skills and by the runtime/UI to select the correct skill set for
     * the current player.
     *
