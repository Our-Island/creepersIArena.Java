 ...
 *
 * @see top.ourisland.creepersiarena.core.component.annotation.CiaJobDef
 * @see top.ourisland.creepersiarena.job.skill.ISkillDefinition
 * @see top.ourisland.creepersiarena.game.mode.impl.battle.BattleKitService
 */
public interface IJob {
     ...
     * <p>
     * This item is a preview/selection icon rather than the actual combat kit. It should communicate the identity of the
     * job clearly through material, display name and lore.
     *
