...
public interface ISkillDefinition {
     ...
     * checks
     * may still be performed later by {@link #executor()}.
     *
     ...
     * {@link top.ourisland.creepersiarena.job.skill.runtime.SkillActivationRejectedException}. Returning normally means
