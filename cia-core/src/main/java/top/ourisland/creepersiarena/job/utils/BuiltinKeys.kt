 ...
 * under the main plugin namespace. Centralising key creation here avoids scattering ad-hoc string literals throughout
...
object BuiltinKeys {
    ...
    /**
     * Creates a [NamespacedKey] owned by the main CreepersIArena plugin.
     *
     ...
     * @return namespaced key under the main plugin namespace
     */
    @JvmStatic
    fun key(value: String): NamespacedKey =
        NamespacedKey(JavaPlugin.getProvidingPlugin(BuiltinKeys::class.java), value)
