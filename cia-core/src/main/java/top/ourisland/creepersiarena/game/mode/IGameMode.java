 ...
 * <p>
 * A game mode is the top-level gameplay package selected for an arena session: it answers "what ruleset is this
 * match running under?" and provides the runtime logic object that drives the session once the mode has been chosen.
 *
 ...
 *
 * @see top.ourisland.creepersiarena.core.component.annotation.CiaModeDef
 * @see ModeLogic
 */
public interface IGameMode {
     ...
     * <p>
     * This method is called when the surrounding game flow needs to instantiate the selected mode for a live match.
     * The returned logic object may keep session-local state, schedule actions and coordinate with other services in
